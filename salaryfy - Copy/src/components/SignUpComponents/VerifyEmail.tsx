            ...
            <div className="flex justify-between  ">
              <div className="flex">
                <input
                  type="number"
                  maxLength={1}
                  className="bg-[#F4F4F4] w-[3.3rem] h-[3.3rem] mr-[1em] border border-[#005F59] border-solid rounded-md outline-none "
                />
                <input
                  type="number"
                  className="bg-[#F4F4F4] w-[3.3rem] mr-[1em] border border-[#005F59] border-solid rounded-md outline-none"
                />
                <input
                  type="number"
                  className="bg-[#F4F4F4] w-[3.3rem] mr-[1em] border border-[#005F59] border-solid rounded-md outline-none"
                ...
                <input
                  type="number"
                  className="bg-[#F4F4F4] w-[3.3rem] border border-[#005F59] border-solid rounded-md outline-none"
                />
              </div>
