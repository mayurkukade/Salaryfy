...
const TermOfUse = () => {
  return (
    <div className="container mx-auto my-[2rem] md:my-[0rem] flex flex-col gap-[1rem]">
      ...
      <TermsBlock><h3>Binding Arbitration and Class Action Waiver</h3>
        <p>
      ...
      <TermsBlock><h3>Acceptable Use Policy</h3>
        <p>
      ...
      <TermsBlock><h3>Copyright and Trademark Policy</h3>
      ...
      <TermsBlock><h3>Trademark Policy</h3>
      ...
      <TermsBlock><h3>Counter-Notice</h3>
      ...
      <TermsBlock><h3>Miscellaneous Provisions</h3>
      ...
      <TermsBlock><h3>Grievance Redressal Policy</h3>
