    ...
    <div className="w-[35.5rem] h-[29.9375rem] rounded-3xl bg-[#fff] shadow-[7px 16px 56px 1px rgba(0, 0, 0, 0.10)] text-darkGreen">
      ...
      <div className="text-[1.25rem] font-[400] mt-5 ml-[5rem] ">
        ...
        <div className='flex justify-between '>
              <div className='flex '>
                <input type="number"  pattern="[0-9]" className='bg-[#F4F4F4] w-[3.3rem] h-[3.3rem] mr-[1em] border border-[#005F59] border-solid rounded-md outline-none '  />
                <input type="number" className='bg-[#F4F4F4] w-[3.3rem] mr-[1em] border border-[#005F59] border-solid rounded-md outline-none' />
                <input type="number" className='bg-[#F4F4F4] w-[3.3rem] mr-[1em] border border-[#005F59] border-solid rounded-md outline-none' />
                <input type="number" className='bg-[#F4F4F4] w-[3.3rem] border border-[#005F59] border-solid rounded-md outline-none' />
              </div>
