        ...
        <div className="app-box-shadow">
          ...
          <div>
            <div className="flex justify-between">
              <p className="text-darkGreen font-Lexend text-[1.25rem] font-semibold flex ">
                <svg
                ...
                <span>Essentail Requirements</span>
              </p>
              <p className="flex ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-darkGreen font-medium font-Lexend">
                  Job Details
                </span>
              </p>
            </div>
            ...
            <div className="p-5 ">
              ...
              <div className="flex bg-yellow text-darkGreen ml-3 w-fit p-5 h-[43px] rounded-lg  justify-center items-center relative  ">
