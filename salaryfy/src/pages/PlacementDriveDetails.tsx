  ...
  async function fetchJob() {
    try {
      ...
      if (error instanceof TypeError) {
        navigateToPlacementDrive(); return;
      }
    }
  }
    ...
    <div className="w-100 flex flex-col items-center h-[100%]">
      ...
      <div className="flex gap-[5em] px-[4em] py-[4em] flex-col-reverse md:flex-row">
        <div className="flex justify-center">
          <div className="max-w-[36em] flex flex-col gap-[2em]"><div className="text-[#0E5F59] text-[2.8em] font-medium mb-5">Our candidates placements</div><div><PlacementCarousel /></div></div>
        </div>
        <div>
          ...
          <div className="app-box-shadow mb-[5em] rounded-[2em]">
            ...
            <div className="px-[5em] py-[0.5em]">
              ...
              <p className="text-[1.6em]">{ jobDetails.essentialRequirements }</p>
              <div><GreenHeading label="Incentive" /><ol className="text-[1.6em]">{jobDetails.incentives}</ol></div>
              <div className="text-[1.6em]"><GreenHeading label="Interview Details" /><p className="mb-[1em]">{jobDetails.interviewDetails}</p>
              </div>
