const AboutUs = () => {
  return (
    ...
    <div className="container mx-auto p-4 md:p-10 border-2 border-black">
    <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
      ...
      <img
        alt="logo"
        src="../../assets/About/about-img.34a85e48f152a6adf519.png"
        className="w-1/4 md:mr-[5rem]"
      />
    </div>
  
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 justify-center items-center mt-8">
      <div className="text-center">
        <img
          alt="purpose"
          src="../../assets/About/download.png"
          className="mx-auto"
        />
      ...
      <div className="text-center">
        <img
          alt="mission"
          src="../../assets/About/download (1).png"
          className="mx-auto"
        />
      ...
      <div className="text-center">
        <img
          alt="vision"
          src="../../assets/About/download (2).png"
          className="mx-auto"
        />
    ...
    <div className="grid grid-cols-1 md:grid-cols-[3.9375rem,auto] gap-4 items-center mt-8">
      ...
      <div className="text-[#5b5b5b] font-normal col-span-1 md:col-span-2">
        <p className="text-sm md:text-base">
          ...
          comprehensive insights into job trends, placements, job
          bench-marking, and salary optimization. The company has a team of
          experienced professionals that leverage the latest data analytics
          technologies to bring meaningful insights to their clients. With
          their insights, clients can improve their salary packages and make
          better decisions related to salary matters.
        </p>
  ...
  <div className="mt-2 md:mt-0 text-[#5b5b5b]">
    <ul className="list-disc pl-4">
      <li className="text-sm md:text-base mb-2">
        ...
        are designed to help clients make informed decisions related
      ...
      <li className="text-sm md:text-base mb-2">
        ...
        potential areas for improvement and recognition of
        performance.
      </li>
...
<div className="mt-8">
  <div className="text-darkGreen font-bold">
    <h2 className="text-xl md:text-2xl">Benefits</h2>
  </div>
  ...
  <div className="mt-2 md:mt-0 text-[#5b5b5b]">
    <p className="text-sm md:text-base">
      ...
      salary management, more attractive salary packages for top
      talent, more effective salary structures, and better insights
      into market dynamics. All of these benefits can help
      companies/users to stay ahead of the competition and ensure that
    ...
    <p className="text-sm md:text-base mt-4">
      ...
      technologies to bring meaningful insights to their clients,
      helping them make better decisions related to salary matters,
      placements, job changes, etc.
    </p>
  </div>
</div>
</div>
