  ...
  return (
    <div className='flex justify-center mt-6'>
      <div className='flex items-center px-[1.5em] py-[0.5em] rounded-xl bg-[#B3B3B3] mx-[1em]'  onClick={backHandler}>
        ...
        <span className='text-[2em] text-[#5B5B5B] font-medium mr-[0.5em] cursor-pointer' >Back</span>
      </div>
      <div className='flex items-center bg-[#FECD08] px-[1.5em] py-[0.5em] rounded-xl mx-[1em]' onClick={nextHandler}>
        <button className='text-[2em] font-medium mr-[0.5em] text-[#005F59] cursor-pointer' >Next</button>
