...
(id)
  ...
  (`Secreen question validation is ${screeningQuestionValidation}`);
  ("Secreen question Response is ", screeningQuestionResponse);
  ...
  (currentRoutee);
  (registerFormData[0]);
  (resSteptwoSelector && verifyEmailFlagSelector);
  (resSteptwoSelector);
  (verifyEmailFlagSelector);
