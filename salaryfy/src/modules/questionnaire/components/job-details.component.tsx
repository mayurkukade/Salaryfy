    ...
    <>
      ...
      <div className="block md:hidden">
        ...
        <div className="flex flex-col items-center p-[2em]" style={{ background: "linear-gradient(rgba(254, 205, 8, 0.07), rgb(14, 95, 89, 0.09))" }}>
          ...
          {/* FIRST */}
          <div className="flex items-center text-[1.8em] font-semibold text-[#0E5F59] px-[2em]">
            <div className="relative mt-[1em] min-w-[5em]">
              <div className="absolute w-[5em] h-[5em] p-[0.5em] flex items-center justify-center rounded-md bg-[#D7E8F0] -translate-y-full overflow-hidden">
                <img src={content.logo} />
              </div>
          ...
          <div className="w-[100%] flex flex-col gap-[1em]">
            <div className="text-[1.8em] font-[700]">{content?.jobDetails}</div>
