      ...
      <div className='hidden md:block z-[-1]' >
        ...
        <div className='flex' style={{ background: 'linear-gradient(rgba(254, 205, 8, 0.07), rgb(14, 95, 89, 0.09))' }}>
          ...
          <div className='px-[1em] py-[1em]'>
            <div className='text-[2em] font-bold mb-[0.5em]'>{jobDetails?.jobDetails}</div>
            <div className='flex text-[1.4em] font-medium'>
              <div><span>Location:&nbsp;</span><span className='text-[#0E5F59]'></span>{jobDetails?.location}</div>
              <div className='mx-2 w-[1px] h-[1.4em] bg-[#0E5F59]'></div>
              <div><span>Starting Salary:&nbsp;</span><span className='text-[#0E5F59]'>{jobDetails?.startingSalary}</span></div>
            </div>
          </div>
          ...
          <div className='flex-grow flex justify-end px-[2em] items-center'>
            <div className='w-[fit-content] h-[fit-content] bg-white flex items-center border border-[#0E5F59] border-solid py-[0.5em] px-[1em] rounded-[2em]'>
              <CalendarVector />
              <div className='ml-[0.5em] text-[1.3em] text-[#0E5F59] font-medium'>Interview on: {jobDetails?.interviewStartDate}</div>
            </div>
          </div>
      ...
      <div className='block md:hidden'>
        ...
        <div className='flex flex-col items-center p-[2em]' style={{ background: 'linear-gradient(rgba(254, 205, 8, 0.07), rgb(14, 95, 89, 0.09))' }}>
          ...
          <div className='w-[100%] flex flex-col gap-[1em]'>
            <div className='text-[1.8em] font-[700]'>{jobDetails?.jobDetails}</div>
            ...
            <div className='text-[1.4em] font-medium'><span className='text-[#5B5B5B]'>Starting Salary:&nbsp;</span><span className='text-[#0E5F59]'>{jobDetails?.startingSalary}</span></div>
