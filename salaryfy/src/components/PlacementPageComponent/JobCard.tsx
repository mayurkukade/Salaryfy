  ...
  return (
    ...
    >
      <div className="grid grid-cols-6 p-5 gap-2 ">
        <div className=" bg-slate-100 p-2 rounded-xl col-span-1">
          <img src={lenscartlogo} />
        </div>
        <div className="flex-row p-2 ml-2 col-span-3">
          <p>Sales Associates(Frontend Sales)</p>
          <p>Lenskart</p>
        </div>
        <div className="col-span-2  ">
          <div
            className="flex p-2 align-text-top rounded-xl "
