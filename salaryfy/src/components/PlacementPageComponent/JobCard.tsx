        ...
        <div className="flex">
          <div className={`w-[max-content] h-[max-content] flex gap-[1em] items-center px-[1em] py-[0.25em] border border-solid border-[${isWithin48Hours(details?.interviewStartDate) ? '#EA4335' : '#0E5F59'}] rounded-[1.5em]`}>
            ...
            {!isWithin48Hours(details?.interviewStartDate) && <><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-[#0E5F59] text-[1.3em] font-medium">Interview on: {details.interviewStartDate ? formatDate(details?.interviewStartDate) : 'N/A'}</span>
            </>}
          </div>
        </div>
      </div>
