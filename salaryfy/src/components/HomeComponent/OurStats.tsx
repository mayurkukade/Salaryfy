  ...
  return (
    <div className="bg-lightBlue lg:h-[8rem] xs:h-[18rem] xs:p-2">
      ...
      >
        ...
        >
          <p className="text-[2rem] font-semibold mt-5 lg:mt-0 lg:text-center xs:text-start xs:ml-5">5000+</p>
        ...
        <div
          ...
          // style={{ borderRight: "1px solid grey" }}
        >
          <p className="text-[2rem] font-semibold xs:text-start xs:ml-5 lg:text-center ">200%</p>
          <p className="text-[1rem] font-medium xs:text-start xs:ml-5 lg:text-center ">Maximum Hike</p>{" "}
        </div>

        {/* Column 4 */}
        <div className="w-[50%] md:w-[25%] mb-8 ">
          <p className="text-[2rem] font-semibold mt-5 lg:mt-0 xs:text-start xs:ml-5">5 Days</p>
          <p className="text-[1rem] font-medium xs:ml-5 text-start">
