...
const Footer = () => {
  return (
    <div className="w-full bg-darkGreen h-[16rem]  ">
        ...
        <div className="grid grid-cols-1  gap-8 lg:grid-cols-3 ">
          <div className="flex flex-col mt-14 ">
            ...
            <p className="mt-8  text-white text-[1.1rem] text-center">
              We exist to re-define the market value <br /> of a job seeker for
              his betterment.
            </p>
          </div>
          ...
          <div className="flex gap-[50px] p-1 justify-center bg-darkGreen mt-12">
            ...
            <div className="md:ml-[150px] bg-darkGreen">
              <p className="font-extrabold text-white text-[1.5rem]">Company</p>
          ...
          {/* Follow US */}
          <div className="lg:mt-12  laptop:mt-12 xs:mt-9 bg-darkGreen mb-8">
      ...
      <p className="text-xs  lg:p-8 text-gray-300 text-center    bg-darkGreen">
