const HeroSection = () => {
  return (
    <>
      <div className="bg-[url('./src/img/bg/svgviewer-output.svg')] h-[170.697px] bg-cover bg-center relative ">
        <div className="flex">
          ...
          <p className=" font-Lexend  text-[68px]">
            <span className="text-yellow">Job Change</span>  <span className="text-darkGreen">solution</span> 
          </p>
